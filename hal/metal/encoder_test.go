...
func TestRenderPassDeferredStateKeepsLatestValues(t *testing.T) {
	...
	pass.SetViewport(hal.Viewport{X: 1, Y: 2, Width: 3, Height: 4, MinDepth: 0.25, MaxDepth: 0.75})
	pass.SetScissorRect(hal.ScissorRect{X: 5, Y: 6, Width: 7, Height: 8})
...
func TestRenderPassDeferredStateUsesBoundedStorage(t *testing.T) {
	...
	allocs := testing.AllocsPerRun(100, func() {
		...
		pass.SetViewport(hal.Viewport{X: 0, Y: 0, Width: 10, Height: 10, MinDepth: 0, MaxDepth: 1})
		pass.SetScissorRect(hal.ScissorRect{X: 0, Y: 0, Width: 10, Height: 10})
