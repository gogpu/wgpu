...
- **HAL ResetFence** — Reset fence to unsignaled state
  - `Device.ResetFence(fence Fence) error` added to HAL interface
  - Vulkan implementation using `vkResetFences`
  - Enables fence reuse in submission tracking pattern
